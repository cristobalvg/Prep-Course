...
function devolverUltimoElemento(array) {
  ...
  // Tu código:
  var devolverarray = array;
  return devolverarray[devolverarray.length - 1];
  /*Otro forma sería:
...
function incrementarPorUno(array) {
  ...
  // y devuelve el array
  // Tu código:
  var incrementoarray = array;
  for(let i = 0; i < incrementoarray.length; i++){
    incrementoarray[i] = incrementoarray[i] + 1;
...
function promedioResultadosTest(resultadosTest) {
  ...
  for(let i = 0; i < resultadosTest.length; i++){
    if(sumapromedio = sumapromedio + resultadosTest[i]);
  }
  return sumapromedio / resultadosTest.length;
}
