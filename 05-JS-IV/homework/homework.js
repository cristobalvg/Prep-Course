...
function multiplicarNumeroDesconocidoPorCinco (objetoMisterioso) {
  ...
  return producto;
  /*O también se puede resolver así:
...
function verificarPassword (usuario, password) {
  ...
  return false;
  /*También funciona con notación de puntos:
  if(password === usuario.password) return true;
  return false;
  */
}
...
function agregarMetodoCalculoDescuento (producto) {
  ...
  return producto;
  Otra forma de hacerlos es la siguiente, con this que se refiere al objeto en donde se invocó:
  */
  producto["calcularPrecioDescuento"] = function(){
